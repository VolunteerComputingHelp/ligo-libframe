function [data,varargout] = frgetvectN(fname,cname,varargin)
% FRGETVECTN - extract from a frame file the data for a channel
%    and for ADC channel normalize it using the "slope" if available
%
